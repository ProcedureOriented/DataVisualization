from tkinter import Button, Frame, LabelFrame, Menu, Tk, Checkbutton, BooleanVar, Label
...
mainWindow = Tk()
mainWindow.title('面向微博的疫情热点及用户情绪分析')
...
# left label frame
leftLabelFrame = LabelFrame(mainWindow, text = "请选择要查看的类别", labelanchor="nw")
...
emptyBottom1 = Label(leftBg, text = '\n\n面向微博的疫情热点及用户情绪分析\n（在此仅展示图片，图片解说请参见论文）\n\nby：洪之灏 陈博文 张嘉宇\n© 2020').grid(row=8)
